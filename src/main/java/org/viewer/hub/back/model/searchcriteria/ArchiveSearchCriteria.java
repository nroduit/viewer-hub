 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.DEDUCTION, defaultImpl = ArchiveSearchCriteria.class)
@JsonSubTypes({ @JsonSubTypes.Type(value = WeasisArchiveSearchCriteria.class),
