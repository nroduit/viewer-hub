...
public class RedisConfiguration {
	...
	public RedisTemplate<String, Manifest> manifestRedisTemplate(RedisConnectionFactory connectionFactory) {
		...
		template.setValueSerializer(new JacksonJsonRedisSerializer<>(Manifest.class));
		return template;
	}
	...
	public RedisTemplate<String, PackageVersionEntity> packageVersionRedisTemplate(
		...
		template.setConnectionFactory(connectionFactory);
		template.setKeySerializer(new StringRedisSerializer());
		template.setValueSerializer(new JacksonJsonRedisSerializer<>(PackageVersionEntity.class));
		return template;
	}
