...
import org.viewer.hub.back.model.ErrorMessage;
import org.viewer.hub.back.model.Launches;
...
import org.viewer.hub.back.util.SpringDocUtil;
...
public class LaunchPreferenceController {
	...
	@GetMapping(value = { "/launch" },
			produces = { ApiVersion.V1_APPLICATION_XML_VALUE, ApiVersion.V1_APPLICATION_JSON_VALUE })
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Bad request",
					content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@GetMapping(value = { "/launch/group/{groupName}" }, produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_search')")
	...
	@GetMapping(value = { "/launch_prefered" }, produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Bad request",
					content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@GetMapping(value = { "/launch_prefered/{preferedType}" }, produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_search')")
	...
	@GetMapping(value = { "/launch_config" }, produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_read')")
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Bad request",
					content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@PostMapping(value = "/launch", consumes = { ApiVersion.V1_APPLICATION_JSON_VALUE },
	...
	@ApiResponses(
			value = {
					...
					@ApiResponse(responseCode = "400", description = "Bad request",
							content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@PostMapping(value = "/launch_config", consumes = { ApiVersion.V1_APPLICATION_JSON_VALUE },
			produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_create')")
	...
	@ApiResponses(
			value = {
					...
					@ApiResponse(responseCode = "400", description = "Bad request",
							content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@PostMapping(value = "/launch_prefered", consumes = { ApiVersion.V1_APPLICATION_JSON_VALUE },
			produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_create')")
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Bad request",
					content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@DeleteMapping(value = "/launch", consumes = { ApiVersion.V1_APPLICATION_JSON_VALUE },
			produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Bad request",
					content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@DeleteMapping(value = "/launch_config", produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_delete')")
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Bad request",
					content = @Content(schema = @Schema(implementation = ErrorMessage.class))) })
	@DeleteMapping(value = "/launch_prefered", produces = { ApiVersion.V1_APPLICATION_JSON_VALUE })
	@PreAuthorize("hasAuthority('viewerhub_delete')")
