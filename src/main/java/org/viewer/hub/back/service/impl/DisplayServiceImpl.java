...
public class DisplayServiceImpl implements DisplayService {
    ...
    public String viewerLaunchUrl(SearchCriteria searchCriteria, Authentication authentication) {
        ...
        // Specific case for Weasis: if Weasis directly requested as a viewer, determine patients later in the process in a
        ...
        if (!Objects.equals(searchCriteria.getViewer(), ViewerType.WEASIS)){
            ...
            patientsByArchive = searchCriteria instanceof ArchiveSearchCriteria ?
                    this.connectorQueryService.retrievePatientsByArchiveWithoutIHESearchCriteria((ArchiveSearchCriteria) searchCriteria, authentication)
                    : this.connectorQueryService.retrievePatientsByArchiveWithIHESearchCriteria((IHESearchCriteria) searchCriteria, authentication);
        }
