...
public interface ConnectorQueryService {
	 ...
	 */
	Set<Patient> retrievePatientsWithoutIHESearchCriteria(ArchiveSearchCriteria searchCriteria, Set<String> archives,
	 ...
	 * @return patients found
	 */
	Set<Patient> retrievePatientsWithIHESearchCriteria(IHESearchCriteria searchCriteria, Set<String> archives,
			Authentication authentication);
	 ...
	 */
	void buildFromSopInstanceUids(Set<Patient> patients, Set<String> sopInstanceUids, Set<String> archives,
			Authentication authentication);
	 ...
	 * @param archives Archives
	 */
	void buildFromSeriesInstanceUids(Set<Patient> patients, Set<String> seriesUids, Set<String> archives,
			Authentication authentication);
	 ...
	 * @param archives Archives
	 */
	void buildFromStudyAccessionNumbers(Set<Patient> patients, Set<String> accessionNumbers, Set<String> archives,
			Authentication authentication);
	 ...
	 * @param archives Archives
	 */
	void buildFromStudyInstanceUids(Set<Patient> patients, Set<String> studyUids, Set<String> archives,
			Authentication authentication);
	 ...
	 * @param archives Archives
	 */
	void buildFromPatientIds(Set<Patient> patients, Set<String> patientIds, Set<String> archives,
			Authentication authentication);
	 ...
	 */
	Map<String, Set<Patient>> retrievePatientsByArchiveWithoutIHESearchCriteria(ArchiveSearchCriteria searchCriteria,
			Authentication authentication);
	 ...
	 * @return patients found by archive
	 */
	Map<String, Set<Patient>> retrievePatientsByArchiveWithIHESearchCriteria(IHESearchCriteria searchCriteria,
			Authentication authentication);
