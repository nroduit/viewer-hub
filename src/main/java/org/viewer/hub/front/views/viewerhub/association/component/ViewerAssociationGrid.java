...
public class ViewerAssociationGrid extends Grid<ViewerAssociationModel> {
	...
	public ViewerAssociationGrid(ViewerAssociationDataProvider<ViewerAssociationModel> originalDataProvider,
								 ValueProvider<ViewerAssociationModel, ComboBox<Viewer>> comboBoxViewerValueProvider) {
	 ...
	 * @return column built
	 */
	private Column<ViewerAssociationModel> addColumnViewer(ValueProvider<ViewerAssociationModel, ComboBox<Viewer>> multiSelectComboBoxBelongToMemberOfValueProvider) {
